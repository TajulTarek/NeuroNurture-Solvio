...
import {
  childDoctorService,
  DoctorEnrollmentStatus,
  DoctorInfo,
} from "@/shared/services/doctor/childDoctorService";
...
export default function ChildDoctorPage() {
  ...
  const [doctorStatus, setDoctorStatus] =
    useState<DoctorEnrollmentStatus | null>(null);
  const [isLoading, setIsLoading] = useState(true);
  const [activeDoctorTab, setActiveDoctorTab] = useState<
    "overview" | "tasks" | "chat" | "reports"
  >("overview");
  ...
  const loadDoctorData = async (childId: number) => {
    try {
      ...
      if (error instanceof Error && error.message.includes("404")) {
        setError(
          "Doctor service is currently unavailable. Please ensure all backend services are running."
        );
      } else {
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50/30 to-indigo-50/30">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
        ...
        {activeDoctorTab === "tasks" && doctorStatus?.enrolled ? (
          ...
          <ChildReportsList childId={selectedChild?.id || 0} />
        ) : (
            ...
            {!doctorStatus?.enrolled && (
              <div className="text-center mb-12">
                ...
                <p className="text-lg text-gray-600 max-w-2xl mx-auto">
                  Connect with your healthcare provider to access medical
                  resources, track health progress, and manage appointments.
                </p>
              </div>
            )}
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                <Card className="text-center p-6 hover:shadow-lg transition-shadow border-gray-200">
                  ...
                  <p className="text-gray-600 text-sm mb-4">
                    Link your account with a healthcare provider to access
                    medical services.
                  </p>
                ...
                <Card className="text-center p-6 hover:shadow-lg transition-shadow border-gray-200">
                  ...
                  <p className="text-gray-600 text-sm mb-4">
                    Track your health progress and receive personalized
                    recommendations.
                  </p>
                ...
                <Card className="text-center p-6 hover:shadow-lg transition-shadow border-gray-200">
                  ...
                  <p className="text-gray-600 text-sm mb-4">
                    Send game performance reports to doctors for professional
                    analysis.
                  </p>
                  <Button
