...
export default function GestureGameInsights() {
  ...
  const getGestureTime = (
    record: GestureGameRecord,
    gestureName: string
  ): number | null => {
  ...
  const sessionImprovementData = gameHistory
    .map((record, index) => {
      ...
      const averageTime =
        completedGestures > 0 ? totalTime / completedGestures : 0;
        ...
        <div className="text-center py-12">
          <div className="mb-8">
            ...
            <p className="text-xl font-comic text-gray-600 max-w-2xl mx-auto">
              Master hand gestures with fun challenges! Play new games and track
              your progress.
            </p>
          </div>
        </div>
          ...
          <Card className="card-playful backdrop-blur-sm bg-white/90 border-2 border-yellow-200 shadow-xl">
            <CardContent className="p-12 text-center">
              ...
              <p className="text-lg font-comic text-muted-foreground mb-8 max-w-md mx-auto">
                {selectedChild.name} hasn't played the Gesture Game yet. Start
                playing to unlock amazing insights and track your progress!
              </p>
              <Button
                  ...
                  <div className="relative bg-gradient-to-br from-white/95 to-white/85 backdrop-blur-sm rounded-3xl border-2 border-blue-200/50 shadow-2xl p-8">
                    <div className="text-center mb-8">
                      ...
                      <p className="text-lg font-comic text-gray-600">
                        Let's see how {selectedChild.name} is doing with hand
                        gestures!
                      </p>
                    </div>
                        ...
                        <div className="relative bg-gradient-to-br from-blue-50 to-indigo-50 rounded-2xl border-2 border-blue-200 p-6 text-center hover:scale-105 transition-all duration-300 shadow-lg hover:shadow-2xl">
                          ...
                          <div className="text-4xl font-bold text-blue-600 mb-2">
                            {(() => {
                              const avgTime =
                                Object.values(
                                  statistics?.averageCompletionTimes || {}
                          ...
                          <div className="text-4xl font-bold text-purple-600 mb-2">
                            {(() => {
                              const totalGestures = Object.values(
                                statistics?.gestureCompletionCounts || {}
                              ).reduce((sum, count) => sum + count, 0);
                              const totalPossible =
                                (statistics?.totalGames || 0) *
                                GESTURE_NAMES.length;
                              const accuracy =
                                totalPossible > 0
                                  ? (totalGestures / totalPossible) * 100
                                  : 0;
                  ...
                  <div className="relative bg-gradient-to-br from-yellow-50/90 to-orange-50/90 backdrop-blur-sm rounded-3xl border-2 border-yellow-200/70 shadow-xl p-8">
                    <div className="text-center">
                      ...
                      <p className="text-lg font-comic text-orange-600 mb-6 max-w-2xl mx-auto">
                        Every practice session makes you better at hand
                        gestures. You're doing amazing, {selectedChild.name}! 🎉
                      </p>
                ...
                <div className="relative">
                  ...
                  <div className="relative bg-gradient-to-br from-white/95 to-white/85 backdrop-blur-sm rounded-3xl border-2 border-blue-200/50 shadow-2xl p-8">
                    <div className="text-center mb-8">
                      ...
                      <p className="text-lg font-comic text-gray-600">
                        Deep dive into {selectedChild.name}'s hand gesture
                        mastery!
                      </p>
                    </div>
                  </div>
                      ...
                      <div className="p-8 relative z-10">
                        <div className="text-center mb-6">
                          ...
                          <p className="text-sm font-comic text-blue-600">
                            How long it takes to complete each gesture on
                            average
                          </p>
                        </div>
                        ...
                        <div className="text-center">
                          ...
                          <div className="bg-white/70 rounded-2xl p-6 border border-orange-200/50">
                            <div className="text-5xl font-bold text-orange-600 mb-2 animate-pulse">
                              {(() => {
                                if (sessionImprovementData.length < 2)
                                  return "0";
                                const firstSession = sessionImprovementData[0];
                                const lastSession =
                                  sessionImprovementData[
                                    sessionImprovementData.length - 1
                                  ];
                                const improvement =
                                  ((firstSession.averageTime -
                                    lastSession.averageTime) /
                                    firstSession.averageTime) *
                                  100;
                          ...
                          <div className="bg-white/70 rounded-2xl p-4 border border-pink-200/50">
                            <div className="space-y-3">
                              {averageTimesData
                                ...
                                .sort(
                                  (a, b) =>
                                    b.completionRatio - a.completionRatio
                                )
                                .slice(0, 5)
                                .map((item, index) => (
                                  <div
                                    key={item.gesture}
                                    className="flex items-center justify-between p-2 bg-gradient-to-r from-pink-50 to-rose-50 rounded-lg border border-pink-200/50"
                                  >
                                    <div className="flex items-center gap-2">
                  ...
                  <div className="relative bg-gradient-to-br from-indigo-50/90 to-purple-50/90 backdrop-blur-sm rounded-3xl border-2 border-indigo-200/70 shadow-xl p-8">
                    <div className="text-center">
                      ...
                      <p className="text-lg font-comic text-indigo-600 mb-6 max-w-2xl mx-auto">
                        {selectedChild.name} is showing amazing progress in hand
                        gestures! Keep practicing to improve even more! 🌟
                      </p>
                      <div className="flex justify-center space-x-4 text-2xl">
                        <span
                          className="animate-float"
                      ...
                      {gameHistory.length > 0 ? (
                        <div className="space-y-4">
                          {GESTURE_NAMES.map((gesture) => {
                            const lastSessionTime = getGestureTime(
                              gameHistory[0],
                              gesture
                            );
              ...
              <TabsContent value="history" className="space-y-6">
                <Card className="card-playful backdrop-blur-sm bg-white/90 border-2 border-purple-200 shadow-xl">
                  <CardHeader className="pb-3">
                    ...
                    <CardDescription className="font-comic text-base">
                      Your recent performance history with detailed gesture
                      breakdowns
                    </CardDescription>
                  </CardHeader>
                  <CardContent>
                    <div className="space-y-4">
                      {gameHistory
                        ...
                        .map((record, index) => {
                          const totalTime = GESTURE_NAMES.reduce(
                            (sum, gesture) => {
                              const time = getGestureTime(record, gesture);
                              return (
                                sum +
                          ...
                          const sessionNumber =
                            gameHistory.length - (currentPage * 5 + index);
