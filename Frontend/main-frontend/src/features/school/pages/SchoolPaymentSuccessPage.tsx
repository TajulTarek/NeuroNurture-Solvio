...
const SchoolPaymentSuccessPage: React.FC = () => {
  ...
  const calculateExpiryDate = () => {
    ...
    const expiryDate = new Date(
      now.getTime() + plan.durationInMonths * 30 * 24 * 60 * 60 * 1000
    );
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="text-center">
              ...
              <p className="text-gray-600 text-sm">
                Access your enhanced dashboard with premium features and
                analytics.
              </p>
            </div>
            ...
            <div className="text-center">
              ...
              <p className="text-gray-600 text-sm">
                Add unlimited children to your school and start tracking their
                progress.
              </p>
            </div>
            ...
            <div className="space-y-4">
              <div className="flex items-start space-x-3">
                ...
                <div>
                  ...
                  <p className="text-gray-600 text-sm">
                    Enroll unlimited students without restrictions
                  </p>
                </div>
              </div>
            ...
            <div className="space-y-4">
              <div className="flex items-start space-x-3">
                ...
                <div>
                  ...
                  <p className="text-gray-600 text-sm">
                    Organize competitive learning events
                  </p>
                </div>
              </div>
              ...
              <div className="flex items-start space-x-3">
                ...
                <div>
                  ...
                  <p className="text-gray-600 text-sm">
                    Export reports and student data
                  </p>
                </div>
              </div>
            </div>
        ...
        <div className="text-center mt-8">
          <p className="text-gray-600">
            ...
            <a
              href="mailto:support@neuronurture.com"
