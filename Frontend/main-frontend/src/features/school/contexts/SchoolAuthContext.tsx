...
export const SchoolAuthProvider: React.FC<SchoolAuthProviderProps> = ({
  children,
}) => {
  ...
  const login = async (email: string, password: string): Promise<boolean> => {
    ...
    try {
      ...
      if (response.ok) {
        ...
        console.log(
          "SchoolAuthContext: School object from backend:",
          data.school
        );
        console.log(
          "SchoolAuthContext: Backend subscriptionStatus:",
          data.school.subscriptionStatus
        );
        console.log(
          "SchoolAuthContext: Backend subscriptionPlan:",
          data.school.subscriptionPlan
        );
        console.log(
          "SchoolAuthContext: Backend subscriptionExpiry:",
          data.school.subscriptionExpiry
        );
        console.log("SchoolAuthContext: Parsed school data:", schoolData);
        console.log(
          "SchoolAuthContext: Parsed subscriptionExpiry:",
          schoolData.subscriptionExpiry
        );
        console.log(
          "SchoolAuthContext: Parsed subscriptionPlan:",
          schoolData.subscriptionPlan
        );
