  ...
  return (
    <div className="fixed right-0 top-1/2 transform -translate-y-1/2 z-[60]">
      <button
        type="button"
        onClick={onClick}
        className="group relative transition-all duration-500 ease-in-out transform cursor-pointer translate-x-4 hover:translate-x-1 scale-100 hover:scale-105"
      >
        {/* Main Button */}
        <div className="w-14 h-14 rounded-l-2xl shadow-xl flex items-center justify-center transition-all duration-300 bg-gradient-to-br from-indigo-500 via-purple-500 to-pink-500 hover:from-indigo-600 hover:via-purple-600 hover:to-pink-600">
