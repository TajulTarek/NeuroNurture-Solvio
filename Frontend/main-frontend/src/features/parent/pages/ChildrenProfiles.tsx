      ...
      <div className="max-w-6xl mx-auto pt-8 px-4 relative z-20">
        ...
        <div className="text-center mb-8">
          <p className="text-lg text-muted-foreground font-comic">
            Use the user menu in the top-right corner to access parent info and
            other options!
          </p>
        </div>
          ...
          {children.map((child, index) => {
            ...
            return (
              ...
              >
                ...
                {/* Floating Icon */}
                <div
                  className={`absolute top-1 left-1 opacity-60 text-fun-blue ${animationClass}`}
                >
                ...
                <div className="p-2 text-center relative h-full flex flex-col justify-center">
                  {/* Child Avatar */}
                  <div
                    className={`text-4xl mb-2 ${animationClass} group-hover:scale-125 transition-transform duration-300 group-hover:rotate-12`}
                  >
