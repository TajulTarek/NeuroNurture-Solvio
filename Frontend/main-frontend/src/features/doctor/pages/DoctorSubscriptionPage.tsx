              ...
              {isSubscriptionActive() ? (
                <div className="space-y-4">
                  <div className="flex items-center justify-between py-3 border-b border-gray-200">
                    ...
                    <span className="text-gray-900">
                      {formatDate(doctor?.subscriptionExpiry || "")}
                    </span>
                  </div>
                ...
                <div className="text-center py-8">
                  ...
                  <p className="text-gray-600 mb-4">
                    Limited to {doctor?.maxChildren || 3} patients. Upgrade to
                    unlock unlimited patients and premium features.
                  </p>
                  <Link
                    to="/doctor/pricing"
                ...
                <div>
                  <div className="flex justify-between items-center mb-2">
                    ...
                    <span className="text-sm text-gray-500">
                      {doctor?.currentChildrenCount || 0} /{" "}
                      {isSubscriptionActive() ? "∞" : doctor?.maxChildren || 3}
                    </span>
                  </div>
            ...
            {!isSubscriptionActive() && (
              <div className="bg-gradient-to-br from-black via-red-600 to-red-700 rounded-lg shadow-lg p-6 text-white">
                ...
                <p className="text-sm text-gray-200 mb-4">
                  Unlock unlimited patients and premium features to enhance your
                  practice.
                </p>
            ...
            {isSubscriptionActive() && (
              <div className="bg-gradient-to-br from-green-500 to-green-600 rounded-lg shadow-lg p-6 text-white">
                ...
                <p className="text-sm text-green-100 mb-4">
                  You're enjoying all premium features and unlimited patient
                  access.
                </p>
