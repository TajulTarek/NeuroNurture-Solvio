...
import {
  DoctorChild,
  doctorChildrenService,
} from "@/shared/services/doctor/doctorChildrenService";
import {
  DoctorTaskCreateRequest,
  DoctorTaskService,
} from "@/shared/services/doctorTaskService";
import {
  AlertCircle,
  ArrowLeft,
  Calendar,
...
const CreateDoctorTask: React.FC = () => {
  ...
  useEffect(() => {
    const fetchChildren = async () => {
      ...
      try {
        ...
        const childrenData = await doctorChildrenService.getChildrenByDoctor(
          parseInt(doctor.id)
        );
  ...
  const handleInputChange = (
    field: keyof DoctorTaskCreateRequest,
          ...
          <div className="flex items-center mb-4">
            ...
            <div>
              <h1 className="text-3xl font-bold text-gray-900">
                Create Therapeutic Task
              </h1>
              <p className="text-gray-600 mt-2">
                Assign therapeutic tasks to your patients
              </p>
            </div>
          </div>
        </div>
              ...
              {isLoadingChildren ? (
                ...
                <div className="text-center py-8">
                  ...
                  <p className="mt-1 text-sm text-gray-500">
                    You don't have any children assigned to you yet. Contact the
                    admin to get children assigned to your account.
                  </p>
                </div>
              ) : (
                    ...
                    >
                      <Checkbox
                        ...
                        onCheckedChange={(checked) =>
                          handleChildSelection(child.id, checked as boolean)
                        }
                      />
                      <Label
                      ...
                      >
                        <div>
                          ...
                          <div className="text-xs text-gray-400">
                            Parent: {child.parentName} • Problem:{" "}
                            {child.problem}
                          </div>
                        </div>
                      </Label>
                ...
                {availableGames.map((game) => (
                  ...
                  >
                    <Checkbox
                      ...
                      onCheckedChange={(checked) =>
                        handleGameSelection(game, checked as boolean)
                      }
                    />
                    <Label
                      htmlFor={`game-${game}`}
