...
class ReportService {
  ...
  async getPendingReports(
    ...
    const response = await fetch(
      `${this.baseUrl}/reports/doctor/${doctorId}/pending`
    );
   ...
   */
  async getAllDoctorReports(
    doctorId: number
  ): Promise<PerformanceReportResponse[]> {
    const response = await fetch(
      `${this.baseUrl}/reports/doctor/${doctorId}/all`
    );
  ...
  async respondToReport(
    ...
    const response = await fetch(
      `${this.baseUrl}/reports/${reportId}/respond`,
      {
        method: "PUT",
        headers: {
          "Content-Type": "application/json",
  ...
  async getPendingReportsCount(doctorId: number): Promise<number> {
    const response = await fetch(
      `${this.baseUrl}/reports/doctor/${doctorId}/pending/count`
    );
